...
README. Then write Samantha' mining config:
...
```bash
samantha mine doctor        # capability matrix
samantha mine start         # launch gateway + miner-loop subprocesses
samantha mine status        # check sidecar + gateway metrics
samantha mine logs -n 120   # print recent logs
samantha mine stop          # stop mining subprocesses
```
