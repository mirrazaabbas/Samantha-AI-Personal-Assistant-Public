...
- **Persistence:** SQLite database file (default: `~/.samantha/memory.db`)
...
!!! note "Backward compatibility"
    The old `from samantha.memory.bm25 import BM25Memory` still works via backward-compatibility shims, but new code should use the canonical `samantha.tools.storage.*` imports.
...
[Source: docs/intro.md] Samantha is a modular AI framework...
...
samantha memory index ./notes/ --chunk-size 256 --chunk-overlap 32

# Search the memory store
samantha memory search "machine learning"
