...
Samantha is a research framework for composable, on-device AI systems.
...
Samantha is that stack. It is a framework for local-first personal AI, built around three core ideas: shared primitives for building on-device agents; evaluations that treat energy, FLOPs, latency, and dollar cost as first-class constraints alongside accuracy; and a learning loop that improves models using local trace data. The goal is simple: make it possible to build personal AI agents that run locally by default, calling the cloud only when truly necessary. Samantha aims to be both a research platform and a production foundation for local AI, in the spirit of PyTorch.
...
=== "Desktop App"
    ...
    The desktop app is a native window for the Samantha UI.
    ...
    **Step 2.** Download and open the desktop app:
    ...
    [Download for macOS](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_universal.dmg){ .md-button .md-button--primary }

    Also available for [Windows](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_x64-setup.exe), [Linux (DEB)](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_amd64.deb), and [Linux (RPM)](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha-1.0.1-1.x86_64.rpm). See the [Downloads](downloads.md) page for details.

    The app connects to `http://localhost:8000` automatically.

    !!! warning "macOS first launch"

        Run `xattr -cr /Applications/Samantha.app` if the app shows as "damaged".
...
Samantha is built around five composable layers. Each has a clean interface and can be swapped independently.

1. **Intelligence** — Pick a model, or let Samantha pick one for your hardware. Manages the full catalog of local models across providers.
...
-   **OpenAI-Compatible API**
    ...
    `samantha serve` starts a FastAPI server with SSE streaming. Drop-in replacement for OpenAI clients.
...
-   **[Getting Started](getting-started/installation.md)**
    ...
    Install Samantha, configure your first engine, and run your first query.
...
-   **[API Reference](api-reference/samantha/index.md)**
...
Samantha is part of [Intelligence Per Watt](https://www.intelligence-per-watt.ai/), a research initiative studying the efficiency of on-device AI systems. Developed at [Hazy Research](https://hazyresearch.stanford.edu/) and the [Scaling Intelligence Lab](https://scalingintelligence.stanford.edu/) at [Stanford SAIL](https://ai.stanford.edu/).

Read the [blog post](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/) for the full research motivation, architecture details, and experimental results.

## Citation

```bibtex
@misc{saadfalcon2026samanthapersonalaipersonal,
      title={Samantha: Personal AI, On Personal Devices},
...
Follow [@SamanthaAI](https://x.com/SamanthaAI) on X for updates.
