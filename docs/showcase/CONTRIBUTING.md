...
description: How to add your setup to the Samantha Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether Samantha is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/tree/main/src/samantha/recipes/data)** if you want the exact config.
...
✅ "Samantha answers my Discord messages while I sleep."
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the Samantha Discord](https://discord.gg/samantha). You'll get tagged in the post — you don't have to do it yourself.
