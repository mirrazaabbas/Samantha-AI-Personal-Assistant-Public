...
The default path is `~/.samantha/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/samantha/security/index.md) — complete class and function signatures
