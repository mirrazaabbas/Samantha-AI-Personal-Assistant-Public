...
```python
from samantha.intelligence import merge_discovered_models
...
The following names are still importable from `samantha.intelligence` via shim modules, but their canonical locations have moved:
