---
title: Downloads
description: Download the Samantha desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public.git && cd Samantha
...
|----------|----------|-------|
| macOS (Universal) | [:material-download: **Samantha.dmg**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_universal.dmg) | Apple Silicon + Intel |
| Windows (64-bit) | [:material-download: **Samantha-setup.exe**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **Samantha.deb**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **Samantha.rpm**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha-1.0.1-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **Samantha.AppImage**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_amd64.AppImage) | Any distro |
...
by Apple. If you see **"Samantha is damaged and can't be opened"**, run this in
...
```bash
xattr -cr ~/Downloads/Samantha.app
```
