---
title: Installation
description: Get Samantha running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
Samantha runs entirely on your hardware. Choose the interface that fits your workflow.
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/samantha-python/Cargo.toml
...
=== "Step 3: Start backend"
    ...
    ```bash
    uv run samantha serve --port 8000
    ```
...
The desktop app is a native window for the Samantha chat UI. All inference and backend
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **Samantha.dmg**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **Samantha-setup.exe**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **Samantha.deb**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **Samantha.rpm**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **Samantha.AppImage**](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases/download/desktop-v1.0.2/Samantha_1.0.1_amd64.AppImage) |
...
!!! warning "macOS: \"app is damaged\""
    ...
    ```bash
    xattr -cr /Applications/Samantha.app
    ```
    This is normal for open-source apps distributed outside the App Store.

!!! tip "All releases"
    Browse all versions on the [GitHub Releases](https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/releases) page.
...
The command-line interface is the fastest way to interact with Samantha
...
samantha ask --agent orchestrator --tools calculator "What is 137 * 42?"
...
For programmatic access, the `Samantha` class provides a high-level sync API.
...
```python
from samantha import SystemBuilder
...
Samantha uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — Samantha communicates over HTTP. You still need the engine software running on your machine.
...
| `server` | `uv sync --extra server` | OpenAI-compatible API server (`samantha serve`) |
...
Samantha requires at least one inference backend. Choose the one that matches your hardware.
