---
title: Code Snippets
description: Copy-paste patterns for common Samantha tasks
---

# Code Snippets

Ready-to-use patterns for the most common Samantha tasks. Each snippet is self-contained and copy-pasteable.
...
Run with: `samantha compose run research_assistant "quantum computing advances"`

## API Server (1 command)

```bash
samantha serve --port 8000 --engine ollama --model qwen3:8b
```
...
docker run -p 8000:8000 samantha serve --host 0.0.0.0
```
