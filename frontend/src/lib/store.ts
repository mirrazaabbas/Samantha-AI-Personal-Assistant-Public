...
const CONVERSATIONS_KEY = 'samantha-conversations';
const SETTINGS_KEY = 'samantha-settings';
const OPTIN_KEY = 'samantha-optin';
const OPTIN_NAME_KEY = 'samantha-display-name';
const OPTIN_EMAIL_KEY = 'samantha-email';
const OPTIN_ANONID_KEY = 'samantha-anon-id';
const OPTIN_SEEN_KEY = 'samantha-optin-seen';
...
interface Settings {
  theme: ThemeMode;
  apiUrl: string;
  // Local server API key (SAMANTHA_API_KEY). Sent as a Bearer token on
  // /v1 + /api requests so a key-protected `samantha serve` doesn't 401 the
