...
const OPTIN_KEY = 'samantha-desktop-optin';
const OPTIN_NAME_KEY = 'samantha-desktop-display-name';
const OPTIN_EMAIL_KEY = 'samantha-desktop-email';
const OPTIN_ANONID_KEY = 'samantha-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/leaderboard"
            target="_blank"
