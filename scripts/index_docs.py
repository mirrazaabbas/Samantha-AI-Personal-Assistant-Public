#!/usr/bin/env python3
"""Index Samantha docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Samantha docs the boilerplate that
    # crowds retrieval ("Samantha runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does samantha support?",
