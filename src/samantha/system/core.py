"""SamanthaSystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from samantha.channels._stubs import BaseChannel
    from samantha.learning._stubs import RouterPolicy
    ...
    from samantha.security.boundary import BoundaryGuard
    ...
    from samantha.speech._stubs import SpeechBackend
...
class SamanthaSystem:
    ...
    # older positional SamanthaSystem(...) calls retain their original meaning.
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~samantha.channels._stubs.BaseChannel`
            instance whose ``on_message`` method accepts a callable.
        """
        from samantha.core.types import Message
        from samantha.sessions.session import SessionStore
    ...
    def __enter__(self) -> SamanthaSystem:
        return self
