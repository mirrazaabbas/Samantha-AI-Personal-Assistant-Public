...
from samantha.mcp.protocol import MCPError, MCPRequest, MCPResponse
from samantha.mcp.transport import MCPTransport
...
class MCPClient:
    ...
    def initialize(self) -> Dict[str, Any]:
        ...
        params = {
            ...
            "capabilities": {},
            "clientInfo": {"name": "samantha", "version": "0.1.0"},
        }
