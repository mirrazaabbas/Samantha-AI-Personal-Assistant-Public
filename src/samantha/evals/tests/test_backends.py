...
class TestSamanthaDirectBackend:
    @patch("samantha.system.SystemBuilder")
    def test_construction_default(self, mock_builder_cls):
        ...
        backend = SamanthaDirectBackend()
        assert backend.backend_id == "samantha-direct"
    ...
    def test_construction_with_engine_key(self, mock_builder_cls):
        ...
        SamanthaDirectBackend(engine_key="cloud")
...
class TestSamanthaAgentBackend:
    @patch("samantha.system.SystemBuilder")
    def test_construction(self, mock_builder_cls):
        ...
        backend = SamanthaAgentBackend(
            engine_key="cloud",
            agent_name="orchestrator",
            tools=["calculator", "think"],
        )
        assert backend.backend_id == "samantha-agent"
        mock_builder.engine.assert_called_with("cloud")
    ...
    def test_generate_full(self, mock_builder_cls):
        ...
        backend = SamanthaAgentBackend(agent_name="orchestrator")
...
class TestSamanthaDirectBackendBaseUrl:
    """--base-url targeting for the samantha-direct backend."""

    @patch("samantha.system.SystemBuilder")
    def test_base_url_injects_pinned_openai_compat_engine(self, mock_builder_cls):
        from samantha.engine.openai_compat_engines import OpenAICompatEngine
        from samantha.evals.backends.samantha_direct import SamanthaDirectBackend
        ...
        with respx.mock:
            ...
            SamanthaDirectBackend(base_url="http://127.0.0.1:18999/v1", api_key="sk-x")
    ...
    def test_unreachable_base_url_fails_fast_naming_url(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            with pytest.raises(RuntimeError, match=r"http://127\.0\.0\.1:18998"):
                SamanthaDirectBackend(base_url="http://127.0.0.1:18998")
    ...
    def test_no_base_url_keeps_engine_key_path(self, mock_builder_cls):
        ...
        SamanthaDirectBackend(engine_key="vllm")
    ...
    def test_base_url_wins_over_engine_key(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            SamanthaDirectBackend(engine_key="vllm", base_url="http://127.0.0.1:18999")
...
class TestSamanthaAgentBackendBaseUrl:
    """--base-url targeting for the samantha-agent backend."""
    ...
    def test_base_url_injects_pinned_openai_compat_engine(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            SamanthaAgentBackend(base_url="http://127.0.0.1:18999/v1", api_key="sk-x")
    ...
    def test_unreachable_base_url_fails_fast_naming_url(self, mock_builder_cls):
        ...
        with respx.mock:
            ...
            with pytest.raises(RuntimeError, match=r"http://127\.0\.0\.1:18998"):
                SamanthaAgentBackend(base_url="http://127.0.0.1:18998")
    ...
    def test_no_base_url_keeps_engine_key_path(self, mock_builder_cls):
        ...
        SamanthaAgentBackend(engine_key="vllm")
        mock_builder.engine.assert_called_with("vllm")
        mock_builder.engine_instance.assert_not_called()
