...
dropped for samantha-direct/samantha-agent and ignored by terminalbench-native
...
from samantha.evals.cli import _build_backend, _run_terminalbench_native
...
class TestBuildBackendForwardsEndpoint:
    @patch("samantha.evals.backends.samantha_direct.SamanthaDirectBackend")
    def test_samantha_direct_receives_base_url_and_api_key(self, mock_cls):
        _build_backend(
            "samantha-direct",
            "vllm",
            "orchestrator",
    ...
    @patch("samantha.evals.backends.samantha_agent.SamanthaAgentBackend")
    def test_samantha_agent_receives_base_url_and_api_key(self, mock_cls):
        _build_backend(
            "samantha-agent",
            "vllm",
            "orchestrator",
...
class TestTerminalBenchNativeApiBase:
    @patch("samantha.evals.backends.terminalbench_native.TerminalBenchNativeBackend")
...
class TestRunSingleSuiteModeGating:
    @patch("samantha.evals.cli._run_terminalbench_native")
