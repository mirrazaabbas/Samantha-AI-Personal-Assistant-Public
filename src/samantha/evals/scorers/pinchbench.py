...
Provides transcript translation (Samantha events → PinchBench format),
...
from samantha.evals.core.event_recorder import EventType
from samantha.evals.core.scorer import LLMJudgeScorer
from samantha.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Samantha name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from SamanthaAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
