...
from samantha.evals.core.backend import InferenceBackend
from samantha.evals.core.dataset import DatasetProvider
from samantha.evals.core.export import _hardware_info_dict
from samantha.evals.core.scorer import Scorer
from samantha.evals.core.tracker import ResultTracker
...
try:
    from samantha.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from samantha.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from samantha.evals.core.dataset import DatasetProvider as _DP
    ...
    def _process_one(self, record: EvalRecord) -> EvalResult:
        ...
        def _backend_error_result(full: dict, message: str) -> EvalResult:
            ...
            return EvalResult(
                ...
                framework=full.get(
                    "framework",
                    getattr(self._backend, "framework_name", "samantha"),
                ),
        ...
        try:
            ...
            return EvalResult(
                ...
                framework=full.get("framework", "samantha"),
            ...
            return EvalResult(
                ...
                model_answer="",
                error=str(exc),
                framework=getattr(self._backend, "framework_name", "samantha"),
