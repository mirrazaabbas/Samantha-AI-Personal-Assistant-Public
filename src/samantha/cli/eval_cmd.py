"""``samantha eval`` — evaluation framework CLI commands."""
...
@click.option(
    ...
    help=(
        ...
        "--api-key (or set SAMANTHA_BACKEND_BASE_URL/SAMANTHA_BACKEND_API_KEY)."
    ),
)
@click.option(
    "--base-url",
...
def eval_run(
    ...
    if config_path is not None:
        ...
        try:
            from samantha.evals.cli import _run_single
        except ImportError:
    ...
    config = RunConfig(
        ...
        # SAMANTHA_BACKEND_BASE_URL/SAMANTHA_BACKEND_API_KEY.
