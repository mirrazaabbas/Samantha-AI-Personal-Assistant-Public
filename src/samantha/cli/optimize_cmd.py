"""``samantha optimize`` — LLM-driven configuration optimization CLI."""
...
def optimize_run(
    ...
    """Run an optimization loop over Samantha configuration."""
    ...
    if config_path is not None:
        try:
            from samantha.learning.optimize.config import load_optimize_config
        except ImportError:
    ...
    if data is not None:
        try:
            from samantha.learning.optimize.config import load_benchmark_specs
    ...
    try:
        ...
        from samantha.learning.optimize.config import load_objectives
        ...
        try:
            from samantha.evals.cli import _build_judge_backend
...
def skills(policy: str, min_traces: int, dry_run: bool) -> None:
    ...
    from samantha.learning.agents.skill_optimizer import SkillOptimizer
