"""``samantha ask`` — send a query to the assistant."""
...
from samantha.cli._banner import print_banner
from samantha.cli._tool_names import resolve_tool_names
from samantha.cli.hints import hint_no_engine
...
from samantha.intelligence import (
...
# below: a screenshot is sensitive and Samantha is local-first, so sending
...
def _run_research(
    *,
    ...
    from samantha.agents.research_loop import DEFAULT_PLANNER_MODEL, ResearchAgent
    from samantha.connectors.embeddings import OllamaEmbedder
    from samantha.connectors.hybrid_search import HybridSearch
    ...
    # (so ``samantha ask --research "..." > out.md`` still gives a clean
...
def _run_agent(
    ...
    import samantha.agents  # noqa: F401
    ...
    if tool_names:
        ...
        import samantha.tools  # noqa: F401
    ...
    from samantha.mcp.loader import load_mcp_tools_from_config
...
def ask(
    ...
    if capture_screen:
        try:
            from samantha.cli._screen import capture_screen_to_temp
    ...
    # the most common command (`samantha ask "..."`).
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]samantha config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
