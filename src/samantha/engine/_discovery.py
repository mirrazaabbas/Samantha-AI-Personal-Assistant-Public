...
def _make_engine(key: str, config: SamanthaConfig) -> InferenceEngine:
...
def _maybe_register_mining_sidecar_engine() -> None:
    ...
    from samantha.engine._openai_compat import _OpenAICompatibleEngine
...
def discover_engines(config: SamanthaConfig) -> List[Tuple[str, InferenceEngine]]:
