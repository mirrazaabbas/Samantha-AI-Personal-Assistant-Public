...
Recipes are the universal composition format for Samantha.  Each recipe
...
class Recipe:
    ...
    def to_builder_kwargs(self) -> Dict[str, Any]:
        """Convert recipe fields to kwargs for SystemBuilder/Samantha.

        Returns a dict with only the non-None fields, keyed to match
        the SystemBuilder fluent API or Samantha constructor parameters.
        """
        kwargs: Dict[str, Any] = {}
    ...
    def to_eval_suite(
        ...
        """
        from samantha.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from samantha.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.samantha/recipes/`` directory
    4. User ``~/.samantha/operators/`` directory
