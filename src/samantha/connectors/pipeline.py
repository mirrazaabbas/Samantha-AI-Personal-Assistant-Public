...
from samantha.connectors._stubs import Attachment, Document
from samantha.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from samantha.connectors.attachment_store import AttachmentStore
