...
<title>Samantha — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>Samantha</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      Samantha runs models on your own hardware. Every inference call that would
  ...
  <div class="calc-section">
    ...
    <div class="calc-results">
      <div class="calc-card free">
        <div class="cc-label">Samantha</div>
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install Samantha and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public.git
&& cd Samantha && uv sync</code>
