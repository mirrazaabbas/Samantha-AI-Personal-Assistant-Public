...
Stores credentials in ~/.samantha/credentials.toml with 0o600 permissions.
...
from samantha.security.file_utils import secure_write_text
...
def _default_path() -> Path:
    """Resolve the credentials file under the Samantha root (env-aware)."""
