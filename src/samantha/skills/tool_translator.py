"""ToolTranslator — translate external tool names to Samantha equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  Samantha uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → Samantha name
# ---------------------------------------------------------------------------
