...
Single source of truth for every event name and property the Samantha
...
see :mod:`samantha.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`samantha init` finished and config.toml was written.",
        properties={
