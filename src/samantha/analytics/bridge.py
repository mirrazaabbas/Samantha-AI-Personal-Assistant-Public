...
The internal bus (:mod:`samantha.core.events`) carries dozens of
...
from samantha.analytics.redaction import hash_id
from samantha.core.events import Event, EventType
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from samantha.analytics.events import KNOWN_TOOL_NAMES
