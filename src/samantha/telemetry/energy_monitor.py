...
def create_energy_monitor(
    ...
    *allow_estimates* is set and nothing measurable is present, a modelled
    ...
    try:
        from samantha.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from samantha.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from samantha.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from samantha.telemetry.energy_rapl import RaplEnergyMonitor
        ...
        try:
            ...
            if AppleEnergyMonitor.estimate_available():
                logger.warning(
                    ...
                    "`samantha[energy-apple]` for real measurements."
                )
