...
from samantha.core.types import TOKEN_COUNTING_VERSION, Message, TelemetryRecord
from samantha.engine._stubs import InferenceEngine, StreamChunk
from samantha.telemetry.energy_monitor import BASIS_GPU
from samantha.telemetry.gpu_monitor import GpuSample
...
class InstrumentedEngine(InferenceEngine):
    ...
    :class:`~samantha.telemetry.energy_monitor.EnergyMonitor`), it is
