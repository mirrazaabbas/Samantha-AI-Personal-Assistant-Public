...
never blocks ``samantha serve`` request handling or the ``samantha chat`` REPL.
...
The service is started and stopped as part of the Samantha lifecycle (see
...
from samantha.memory.extractor import FactExtractor
