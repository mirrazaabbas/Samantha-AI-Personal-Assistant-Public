...
from samantha.speech._stubs import Segment, SpeechBackend, TranscriptionResult
        ...
        *,
        ...
        try:
            ...
            try:
                ...
                # Some faster-whisper/numpy combinations emit harmless
                # feature-extractor matmul warnings for near-silent frames.
                # The model's VAD/transcription result remains authoritative;
                # keep the interactive terminal free of numerical noise.
