...
from samantha.core.registry import ToolRegistry, TTSRegistry
...
class TextToSpeechTool(BaseTool):
            ...
            parameters={
                ...
                "properties": {
                    ...
                    "backend": {
                        "type": "string",
                        "description": (
                            "TTS backend (macos, cartesia, kokoro, openai_tts)."
                        ),
                    },
                    "output_dir": {
                        "type": "string",
    ...
    def execute(self, **params: Any) -> ToolResult:
        ...
        if output_dir:
            ...
            out_dir = Path(tempfile.mkdtemp(prefix="samantha-tts-"))
