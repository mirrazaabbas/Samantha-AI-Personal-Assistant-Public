...
from samantha.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """Samantha support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "Samantha before mining is enabled by default."
        ),
    ),
    PearlModelSpec(
