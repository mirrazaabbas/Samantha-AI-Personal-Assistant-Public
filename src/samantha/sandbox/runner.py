...
_OUTPUT_START = "---SAMANTHA_OUTPUT_START---"
_OUTPUT_END = "---SAMANTHA_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``samantha-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "samantha-sandbox:latest"
    DEFAULT_TIMEOUT = 300
