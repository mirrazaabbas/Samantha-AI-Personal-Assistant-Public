...
Routes incoming :class:`~samantha.channels._stubs.ChannelMessage` objects
...
from samantha.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Samantha:\nsamantha://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~samantha.agents._stubs.BaseAgent`
        subclass).
    max_workers:
