...
called from your app startup:
    ...
    from samantha.agents.proactive_agent import register_cron
...
from samantha.tools.approval_store import (
...
from samantha.tools.proactive_tools import get_store
...
_PROACTIVE_TASK_KEY_FIELD = "samantha_task_key"
...
def _build_notification_channel(channel_spec: str) -> Optional[Any]:
    ...
    if channel_type == "imessage":
        from samantha.channels._stubs import (
            BaseChannel,
            ChannelStatus,
        )
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from samantha.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from samantha.tools.channel_tools import ChannelSendTool
        from samantha.tools.digest_collect import DigestCollectTool
        from samantha.tools.proactive_tools import (
            CheckPermissionTool,
