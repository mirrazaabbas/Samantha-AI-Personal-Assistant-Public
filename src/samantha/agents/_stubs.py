...
from samantha.core.types import Conversation, Message, Role, ToolResult
...
class BaseAgent(ABC):
    ...
    def _apply_persona(self, system_prompt: Optional[str]) -> Optional[str]:
        ...
        ``samantha ask`` (#376) by *appending* persona to — never replacing —
    ...
    def _build_messages(
        ...
        *,
        ...
        identity_already_applied = any(
            ...
            and message.metadata.get("samantha_identity_prompt")
...
class ToolUsingAgent(BaseAgent):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            from samantha.agents.loop_guard import LoopGuard, LoopGuardConfig
