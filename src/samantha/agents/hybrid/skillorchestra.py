...
scope for the Samantha port (and was out of scope in the hybrid harness).
...
from samantha.agents.hybrid._base import LocalCloudAgent
from samantha.agents.hybrid._prices import supports_temperature
