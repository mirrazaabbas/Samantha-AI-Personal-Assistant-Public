...
from samantha.agents.hybrid._openai_retry import (
    patch_openai_globally as _patch_openai_globally,
)
from samantha.agents.hybrid._prices import NO_TEMP_PREFIXES, default_max_output_tokens
from samantha.agents.hybrid.mini_swe_agent import run_swe_agent_loop
...
def _prefetch_context(
    ...
    try:
        ...
        from samantha.agents.hybrid._prices import cost as _cost_usd
