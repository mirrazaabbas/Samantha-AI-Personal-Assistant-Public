...
matrix (see ``.samantha/experiments/hybrid/docs/results-table.md``).
...
from samantha.agents.hybrid._prices import cost as estimate_cost
from samantha.agents.hybrid._prices import default_max_output_tokens
