...
# src/samantha/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m samantha.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m samantha.agents.hybrid.runner --cell ${name}"
