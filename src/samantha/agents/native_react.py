...
Renamed from ``ReActAgent`` to clarify this is Samantha's native
...
from samantha.agents.prompt_loader import (
...
from samantha.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from samantha.engine._stubs import InferenceEngine
from samantha.tools._stubs import BaseTool, build_tool_descriptions
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $SAMANTHA_HOME override for the base template (M2+ work).
        prompt_template = (
