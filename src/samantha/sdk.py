"""High-level Python SDK for Samantha."""
...
from samantha.system import SamanthaSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def __init__(self, config: SamanthaConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from samantha.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from samantha.tools.storage.chunking import ChunkConfig
...
class Samantha:
    ...
    @property
    def config(self) -> SamanthaConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the Samantha version string."""
        return samantha.__version__
    ...
    def _ensure_engine(self) -> None:
        ...
        try:
            import samantha.engine  # noqa: F401
        except ImportError:
            pass
    ...
    def _run_agent(
        ...
        *,
        ...
        if tools:
            ...
            from samantha.cli.ask import _build_tools
        ...
        if getattr(agent_cls, "accepts_tools", False):
            ...
            if self._confirm_callback is not None:
                agent_kwargs["interactive"] = self._interactive
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from samantha.tools.digest_collect import DigestCollectTool
            from samantha.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from samantha.cli.ask import _get_memory_backend, _get_memory_facts
...
__all__ = ["Samantha", "SamanthaSystem", "MemoryHandle", "SystemBuilder"]
