"""LLM-based optimizer for Samantha configuration tuning.

Uses a cloud LLM to propose optimal Samantha configs, inspired by DSPy's
...
from samantha.core.types import Trace
from samantha.evals.core.backend import InferenceBackend
from samantha.evals.core.types import RunSummary
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Samantha configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Samantha AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Samantha evaluation result.")
        lines.append("")
