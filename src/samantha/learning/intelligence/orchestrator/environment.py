...
Adapted from IPW's ``environment.py``.  Uses Samantha's
:class:`~samantha.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Samantha ``ToolExecutor``.
