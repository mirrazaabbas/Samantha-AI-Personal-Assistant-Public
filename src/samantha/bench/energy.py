...
from samantha.bench._stats import compute_stats
from samantha.bench._stubs import BaseBenchmark, BenchmarkResult, engine_info
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if energy_monitor is not None:
            from samantha.telemetry.steady_state import SteadyStateDetector
