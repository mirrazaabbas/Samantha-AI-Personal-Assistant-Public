...
impl AuditLogger {
    ...
    pub fn log(&self, event: &SecurityEvent) -> Result<(), SamanthaError> {
    ...
    pub fn verify_chain(&self) -> Result<(bool, Option<i64>), SamanthaError> {
        let mut stmt = self
            .conn
            .prepare(
    ...
    pub fn query(
        ...
        since: Option<f64>,
        limit: usize,
    ) -> Result<Vec<SecurityEvent>, SamanthaError> {
