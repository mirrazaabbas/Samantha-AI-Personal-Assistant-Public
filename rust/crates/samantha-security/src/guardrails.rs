...
use samantha_core::error::SamanthaError;
use samantha_core::{EventBus, EventType, GenerateResult, Message};
use samantha_engine::traits::{InferenceEngine, TokenStream};
    ...
    fn handle_findings(
        ...
        match self.mode {
            ...
            RedactionMode::Block => {
                ...
                Err(SamanthaError::Security(
                    samantha_core::error::SecurityError::Blocked(format!(
...
mod tests {
    ...
    fn test_guardrails_block_mode() {
        ...
        let err = guardrails
            .generate(&[Message::user("Hi")], "mock", 0.7, 100, None)
            .unwrap_err();
        assert!(matches!(err, SamanthaError::Security(_)));
    }
}
