...
mod tests {
    use super::*;
    use samantha_tools::builtin::calculator::CalculatorTool;

    fn make_server() -> McpServer {
        let mut exec = ToolExecutor::new(None, None);
        exec.register(samantha_tools::builtin::BuiltinTool::Calculator(CalculatorTool));
