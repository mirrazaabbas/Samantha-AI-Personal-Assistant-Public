...
use samantha_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, samantha_core::SamanthaError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, samantha_core::SamanthaError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, samantha_core::SamanthaError>;

    fn list_models(&self) -> Result<Vec<String>, samantha_core::SamanthaError>;
...
mod tests {
    use super::*;
    use samantha_core::{Message, ToolCall};
