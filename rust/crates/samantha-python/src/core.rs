...
impl PyMessage {
    pub fn to_core(&self) -> samantha_core::Message {
        let role = match self.role.as_str() {
            "system" => samantha_core::Role::System,
            "assistant" => samantha_core::Role::Assistant,
            "tool" => samantha_core::Role::Tool,
            _ => samantha_core::Role::User,
        };
        samantha_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: samantha_core::SamanthaConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: samantha_core::SamanthaConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<samantha_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(samantha_core::EventBus::new(true)),
        }
    }
