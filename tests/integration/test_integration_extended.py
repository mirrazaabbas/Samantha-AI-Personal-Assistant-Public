...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from samantha.agents.native_openhands import NativeOpenHandsAgent
        from samantha.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from samantha.mcp.transport import InProcessTransport
        from samantha.tools.calculator import CalculatorTool
        from samantha.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from samantha.mcp.client import MCPClient
        from samantha.mcp.protocol import MCPError
        from samantha.mcp.server import MCPServer
        from samantha.mcp.transport import InProcessTransport
        from samantha.tools.calculator import CalculatorTool
...
class TestMemoryPipeline:
    ...
    def test_bm25_index_and_retrieve(self, tmp_path):
        try:
            from samantha.tools.storage.bm25 import BM25Memory
        except ImportError:
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from samantha.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
