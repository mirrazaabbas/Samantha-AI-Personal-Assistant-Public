...
class TestDockerFiles:
    ...
    def test_dockerfiles_build_native_rust_extension(self):
        ...
        required_markers = [
            ...
            "rust/crates/samantha-python/Cargo.toml",
            "/tmp/samantha-rust-wheel/*.whl",
            "import samantha_rust",
        ]
    ...
    def test_systemd_service_exists(self):
        assert (SYSTEMD_DIR / "samantha.service").is_file()
...
class TestSystemdHardening:
    ...
    def _service(self) -> str:
        return (SYSTEMD_DIR / "samantha.service").read_text()
