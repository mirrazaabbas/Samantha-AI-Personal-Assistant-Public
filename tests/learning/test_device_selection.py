...
class TestSelectTorchDevice:
    ...
    def test_no_torch_returns_none(self):
        ...
        # Simulate an environment where torch is unavailable.
        import samantha.learning.intelligence.orchestrator.sft_trainer as sft

        original_has_torch = sft.HAS_TORCH
        original_torch = sft.torch
        try:
            sft.HAS_TORCH = False
            sft.torch = None
            assert sft._select_torch_device() is None
        finally:
            sft.HAS_TORCH = original_has_torch
            sft.torch = original_torch
    ...
    def test_exported_from_orchestrator_init(self):
        ...
        from samantha.learning.intelligence.orchestrator import (
