"""Tests for samantha.optimize.trial_runner module."""
...
from samantha.evals.core.types import RunConfig, RunSummary
from samantha.learning.optimize.trial_runner import TrialRunner
from samantha.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "samantha-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "samantha-direct"
...
class TestRunTrial:
    ...
    @patch("samantha.evals.cli._build_scorer")
    @patch("samantha.evals.cli._build_judge_backend")
    @patch("samantha.evals.cli._build_dataset")
    @patch("samantha.evals.cli._build_backend")
    @patch("samantha.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from samantha.evals.core.types import EvalResult
