"""Smoke tests for ``samantha optimize`` and ``samantha feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in SamanthaConfig."""

    def test_optimize_config_in_samantha_config(self):
        from samantha.core.config import OptimizeConfig, SamanthaConfig
    ...
    def test_optimize_config_defaults(self):
        from samantha.core.config import OptimizeConfig
