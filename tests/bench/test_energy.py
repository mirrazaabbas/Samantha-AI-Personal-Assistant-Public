...
from samantha.bench.energy import EnergyBenchmark
from samantha.core.registry import BenchmarkRegistry
from samantha.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from samantha.bench.energy import ensure_registered
