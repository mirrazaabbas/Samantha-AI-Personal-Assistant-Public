...
def test_build_frozen_prefix(memory_dir: Path):
    ...
    builder = SystemPromptBuilder(
        agent_template="You are Samantha.",
...
def test_config_prefix_prepended(memory_dir: Path):
    ...
    builder = SystemPromptBuilder(
        ...
        system_prompt_config=SystemPromptConfig(prefix="ALWAYS ANSWER AS SAMANTHA."),
    )
    prompt = builder.build()
    assert prompt.startswith("ALWAYS ANSWER AS SAMANTHA.")
    assert "You are Samantha." in prompt
