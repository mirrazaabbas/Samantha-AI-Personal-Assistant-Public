...
class TestDetectHardware:
    ...
    @patch("samantha.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "samantha.core.config._run_cmd",
    ...
    @patch("samantha.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "samantha.core.config._run_cmd",
        side_effect=[
    ...
    @patch("samantha.core.config.platform.system", return_value="Darwin")
    @patch(
        "samantha.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("samantha.core.config.shutil.which", return_value=None)
    @patch("samantha.core.config.platform.system", return_value="Linux")
