...
_PATCH_HTTP = "samantha.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "samantha.mcp.transport.StdioTransport"
_PATCH_CLIENT = "samantha.mcp.client.MCPClient"
_PATCH_PROVIDER = "samantha.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "samantha.system.builder.logger"
...
def test_builder_retains_full_mcp_pool_for_managed_agents() -> None:
    ...
    with (
        patch("samantha.mcp.server.MCPServer") as mcp_server_cls,
        patch.object(
            builder,
