"""Tests for context injection integration in ``samantha ask``."""
...
def test_get_memory_backend_returns_backend_even_when_empty(
    ...
    failures downstream.
    """
    from samantha.core.config import MemoryConfig, SamanthaConfig
    ...
    mod = importlib.import_module("samantha.cli.ask")
