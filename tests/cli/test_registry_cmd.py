"""Tests for the ``samantha registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the samantha registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "samantha.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"samantha.core.registry": None}):
