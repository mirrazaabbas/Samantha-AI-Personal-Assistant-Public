"""Tests for model resolution fallback chain in samantha ask."""
...
def _register_agents():
    ...
    The default ``SamanthaConfig().agent.default_agent`` is ``"simple"``,
    so ``samantha ask "..."`` (without ``--agent``) routes through SimpleAgent.
