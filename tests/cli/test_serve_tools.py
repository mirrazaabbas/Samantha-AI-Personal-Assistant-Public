"""Regression tests for tool selection during ``samantha serve`` startup."""

from __future__ import annotations

import pytest

from samantha.cli.serve import _resolve_allowed_tools
...
def test_serve_defaults_tools_when_no_selection_is_configured():
    allowed, explicit = _resolve_allowed_tools(SamanthaConfig())
