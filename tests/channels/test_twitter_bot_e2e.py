...
class TestClassifyMentionDispatch:
    ...
    def test_valid_labels_pass_through(self, llm_label, expected):
        ...
        assert _classify_mention("some tweet", samantha=j) == expected
    ...
    def test_defaults_to_question_if_model_returns_other(self):
        ...
        assert _classify_mention("hahaha", samantha=j) == "QUESTION"
...
# =========================================================================
# 1c. Prompt-injection detector (unit, mocked Samantha)
# =========================================================================
...
class TestPromptBuilders:
    ...
    def test_bug_prompt_contains_github_url(self):
        ...
        assert "api.github.com/repos/samantha-ai/Samantha/issues" in prompt
...
class TestMentionPolling:
    ...
    def test_poll_dispatches_to_handler(self):
            ...
            "data": [
                {
                    "id": "111",
                    "author_id": "alice",
                    "text": "@SamanthaAI how do I install?",
                    "conversation_id": "111",
                },
            ],
        }
        ...
        assert msg.content == "@SamanthaAI how do I install?"
...
class TestEnvVarExpansion:
    ...
    def test_github_token_expanded(self):
        ...
        with (
            ...
            patch(
                "samantha._rust_bridge.get_rust_module",
                return_value=mock_rust,
            ),
            patch("samantha.tools.http_request.check_ssrf", return_value=None),
            patch(
                "samantha.tools.http_request.httpx.request",
...
# =========================================================================
# 5. Full reactive e2e flow (mock Samantha + TwitterChannel)
# =========================================================================
...
class TestFullE2EFlow:
    ...
    def _make_mock_samantha(self, responses=None):
        """Create a mock Samantha instance that returns canned responses."""
        j = MagicMock()
        if responses:
    ...
    def test_question_flow(self):
        ...
        """
        j = self._make_mock_samantha(["check the private Samantha repository"])
        tweet = DEMO_TWEETS[0]
    ...
    def test_bug_report_flow(self):
        ...
        j = self._make_mock_samantha(["opened an issue for this"])
        tweet = DEMO_TWEETS[1]
    ...
    def test_praise_flow(self):
        ...
        j = self._make_mock_samantha(["thanks, glad you like it!"])
        tweet = DEMO_TWEETS[3]
        mention_type = "PRAISE"
    ...
    def test_spam_is_ignored(self):
        """Spam mentions should be skipped — no Samantha.ask call."""
        j = self._make_mock_samantha()
    ...
    def test_all_demo_tweets_processed(self):
        ...
        TestClassifyMentionDispatch against a mocked samantha. This test
...
class TestGitHubIssueCreation:
    ...
    def test_create_bug_issue(self):
        ...
        mock_resp.text = json.dumps(
            {
                "number": 42,
                "html_url": "https://github.com/mirrazaabbas/Samantha-AI-Personal-Assistant-Public/issues/42",
            }
        )
        mock_resp.headers = {"content-type": "application/json"}
        ...
        with (
            ...
            patch("samantha._rust_bridge.get_rust_module", return_value=mock_rust),
            patch("samantha.tools.http_request.check_ssrf", return_value=None),
            patch(
                "samantha.tools.http_request.httpx.request",
                return_value=mock_resp,
