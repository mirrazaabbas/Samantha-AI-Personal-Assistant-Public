...
def recording_mkdtemp(*args, **kwargs):
    ...
    if kwargs.get("prefix") == "samantha-test-home-":
        created.append(path)
    return path

tempfile.mkdtemp = recording_mkdtemp
os.environ["SAMANTHA_HOME"] = "/tmp/samantha-original-home-sentinel"
os.environ["SAMANTHA_CONFIG"] = "/tmp/samantha-original-config-sentinel"
...
assert os.environ["SAMANTHA_HOME"] == "/tmp/samantha-original-home-sentinel"
assert os.environ["SAMANTHA_CONFIG"] == "/tmp/samantha-original-config-sentinel"
