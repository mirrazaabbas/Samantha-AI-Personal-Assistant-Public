...
from samantha.agents.tool_resolver import ResolvedAgentTools
from samantha.connectors.store import KnowledgeStore
from samantha.core.config import MemoryFilesConfig, SystemPromptConfig
from samantha.core.events import EventBus
from samantha.core.registry import AgentRegistry, ToolRegistry
from samantha.core.types import Role, ToolResult
...
def test_executor_closes_resolver_resources_when_pre_run_setup_fails(
    ...
    monkeypatch.setattr("samantha.agents.executor.resolve_agent_tools", _resolve)
    system = SimpleNamespace(
        engine=FakeEngine([{"content": "unused"}]),
        model="test-model",
        memory_backend=None,
