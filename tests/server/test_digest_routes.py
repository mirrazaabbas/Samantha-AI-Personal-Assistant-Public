...
from samantha.agents.digest_store import DigestArtifact, DigestStore
...
def _make_app(db_path: str):
    ...
    from samantha.agents.digest_store import DigestStore
...
def test_get_history(store, tmp_path):
    ...
    data = resp.json()
    assert len(data) == 1
    assert data[0]["voice_used"] == "samantha"
