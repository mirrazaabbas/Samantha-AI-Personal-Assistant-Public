...
from samantha.agents._stubs import AgentResult  # noqa: E402
from samantha.core.events import EventBus  # noqa: E402
from samantha.core.types import ToolResult  # noqa: E402
from samantha.server.models import ChatCompletionRequest  # noqa: E402
from samantha.server.stream_bridge import AgentStreamBridge  # noqa: E402
...
def test_stream_replays_grounded_agent_result_without_second_inference():
    grounded_content = "My name is Samantha. The tool reports 72 degrees."
    agent = MagicMock()
