...
from samantha.server.auth_middleware import websocket_authorized  # noqa: E402
from samantha.server.ws_bridge import create_ws_router  # noqa: E402

AUTH_PROTOCOL = "samantha.auth.v1"
KEY_PROTOCOL_PREFIX = "samantha.key.b64url."
...
class TestWebsocketAuthorizedHelper:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("secret+/=", "samantha.key.b64url.c2VjcmV0Ky89"),
            ("bearer", "samantha.key.b64url.YmVhcmVy"),
            ("sëcret🔑", "samantha.key.b64url.c8OrY3JldPCflJE"),
        ],
    )
