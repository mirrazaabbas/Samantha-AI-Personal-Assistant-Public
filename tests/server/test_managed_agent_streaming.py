...
from samantha.server.agent_manager_routes import (  # noqa: E402
...
class TestBuildManagedSystemPrompt:
    ...
    def _config_with_soul(self, tmp_path):
        ...
        soul.write_text("You are Samantha, a meticulous local-first assistant.")
    ...
    def test_matches_cli_builder_output(self, tmp_path):
        ...
        so streaming chat and `samantha ask` assemble the prompt identically.
        """
        from samantha.core.config import MemoryFilesConfig, SystemPromptConfig
