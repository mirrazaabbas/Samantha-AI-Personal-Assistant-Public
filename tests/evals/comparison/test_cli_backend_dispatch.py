...
from samantha.evals.cli import BACKENDS, _build_backend
...
class TestBuildBackendDispatch:
    def test_backends_dict_includes_external(self) -> None:
        ...
        assert "samantha-agent" in BACKENDS
        assert "samantha-direct" in BACKENDS
    ...
    def test_hermes_returns_hermes_backend(self) -> None:
        ...
        with (
            ...
            patch("samantha.evals.backends.external.hermes_agent.verify_commit_pin"),
        ):
