...
PROVIDERS = [
    ("samantha.evals.datasets.adp", "ADPDataset"),
    ("samantha.evals.datasets.toolorchestra", "ToolOrchestraDataset"),
    ("samantha.evals.datasets.generalthoughts", "GeneralThoughtsDataset"),
]
