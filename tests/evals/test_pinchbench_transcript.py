...
from samantha.evals.core.event_recorder import AgentEvent, EventType
from samantha.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from samantha.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Samantha tool names are mapped to PinchBench-expected names."""
    from samantha.evals.scorers.pinchbench import events_to_transcript
