"""Tests for SamanthaAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestSamanthaAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(SamanthaAgentBackend.__init__)
