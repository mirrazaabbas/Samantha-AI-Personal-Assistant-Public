"""Tests for the Rich display helpers in samantha.evals.core.display."""
...
from samantha.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "Samantha" in output or "___" in output
