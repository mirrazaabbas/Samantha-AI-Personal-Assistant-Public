"""Verify SamanthaAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestSamanthaAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        ...
        with patch("samantha.system.SystemBuilder") as MockSB:
            ...
            backend = SamanthaAgentBackend(model="qwen-9b")
