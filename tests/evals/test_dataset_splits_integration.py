...
PROVIDERS = [
    ("samantha.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("samantha.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("samantha.evals.datasets.gaia", "GAIADataset"),
    ("samantha.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("samantha.evals.datasets.taubench", "TauBenchDataset"),
    ("samantha.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("samantha.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
