...
from samantha.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("samantha.speech.deepgram.DeepgramClient", return_value=mock_client):
        from samantha.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("samantha.speech.deepgram.DeepgramClient"):
        from samantha.speech.deepgram import DeepgramSpeechBackend
