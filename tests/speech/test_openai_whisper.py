...
from samantha.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("samantha.speech.openai_whisper.OpenAI", return_value=mock_client):
        from samantha.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("samantha.speech.openai_whisper.OpenAI"):
        from samantha.speech.openai_whisper import OpenAIWhisperBackend
