...
def connector(tmp_path: Path):
    ...
    from samantha.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("samantha.connectors.dropbox._dropbox_api_list_folder")
@patch("samantha.connectors.dropbox._dropbox_api_download")
