...
def connector(tmp_path: Path):
    ...
    from samantha.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("samantha.connectors.gdrive._gdrive_api_list_files")
@patch("samantha.connectors.gdrive._gdrive_api_export")
