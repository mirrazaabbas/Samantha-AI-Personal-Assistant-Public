...
_LOCAL_CONNECTORS = [
    ("apple_notes", "samantha.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "samantha.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "samantha.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "samantha.connectors.outlook", "OutlookConnector"),
    ("slack", "samantha.connectors.slack_connector", "SlackConnector"),
    ("notion", "samantha.connectors.notion", "NotionConnector"),
    ("granola", "samantha.connectors.granola", "GranolaConnector"),
    ("gdrive", "samantha.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "samantha.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "samantha.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "samantha.connectors.dropbox", "DropboxConnector"),
]
