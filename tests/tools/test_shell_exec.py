...
from samantha.core import get_python_executable
from samantha.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import samantha.tools as tools_pkg
        from samantha.core.registry import ToolRegistry

        sys.modules.pop("samantha.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "SAMANTHA_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "SAMANTHA_TEST_PASSTHROUGH_67890"
...
class TestSanitizedEnvWindowsKeys:
    ...
    def test_base_env_keys_include_windows_essentials(self):
        from samantha.tools.shell_exec import _WINDOWS_ENV_KEYS
    ...
    def test_windows_keys_are_only_enabled_on_windows(self):
        from samantha.tools.shell_exec import _BASE_ENV_KEYS, _WINDOWS_ENV_KEYS
