"""Tests for the persistent fact store (samantha.memory.store)."""
...
from samantha.core.registry import FactStoreRegistry
...
def test_create_fact_store_default_path_uses_samantha_home(tmp_path, monkeypatch):
