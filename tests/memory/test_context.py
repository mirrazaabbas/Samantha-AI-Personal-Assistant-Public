...
from samantha.memory.store import (
    TRUST_AUTO,
    TRUST_TRUSTED,
    TRUST_UNTRUSTED,
    Fact,
...
def test_inject_context_merges_with_existing_system_message():
    messages = [
        Message(role=Role.SYSTEM, content="You are Samantha."),
    ...
    assert messages[0].content == "You are Samantha."
...
def test_inject_context_publishes_event():
    ...
    import samantha.tools.storage.context as mod
