"""Tests for the background memory service (samantha.memory.service)."""
...
from samantha.core.config import StorageConfig
from samantha.core.events import EventBus
from samantha.memory.service import (
    MemoryService,
    build_memory_service,
    publish_completed_exchange,
)
from samantha.memory.store import Fact, FactStore, LocalFactStore
...
def test_extracted_facts_reach_model_context_end_to_end(tmp_path):
    ...
    from samantha.tools.storage.context import inject_context
