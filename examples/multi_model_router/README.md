...
Route queries to the cheapest capable model using Samantha's learning/routing
...
The script uses Samantha's routing infrastructure from the learning pillar:
